                                ...
                                @foreach ($records as $record)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{url(route('restaurants.show',$record->id))}}" class="btn btn-success btn-xs">show</a>
                                          </td>
                                        ...
                                        <td class="text-center">
                                            {!! Form::open([
                                                'action' => ['App\Http\Controllers\Admin\RestaurantController@destroy', $record->id],
                                                'method' => 'delete',
                                            ]) !!}
